...
const ProductDetails = () => {
  ...
  const { imgUrl,productName,price,
    avgRating, reviews, description,shortDesc,category} = product;
          ...
          <Col lg="6">
            <div className='product__details'>
              ...
              <div className='product__rating d-flex align-items-center gap-5 mb-3'>
                ...
                <div className='d-flex align-items-cneter gap-5'>
          ...
          <Col lg='12'>
            <div className='tab__wrapper d-flex align-items-center gap-5'>
                  <h6
                   ...
                   <h6 className={`${tab === 'rev' ? 'active__tab' : "" }`}  onClick={()=> setTab('rev')} style={{ cursor: 'pointer' }}>Reviews ({reviews.length})</h6>
            </div>
