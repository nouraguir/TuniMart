    ...
    <section>
      <Container>
        <Row>
          <Col lg='9'>
          {
            cartItems.length === 0 ? (<h2 className='fs-4 text-center'>No item added to the cart Yet</h2>
            ): (
...
const Tr= ({item})=>{
  ...
  <td>{item.price}</td>
  <td>{item.quantity}</td>
  <td><motion.i class="ri-delete-bin-line"  onClick = { deleteProduct} whileTap={{scale:1.2}}></motion.i></td>
</tr>
}
export default Cart;